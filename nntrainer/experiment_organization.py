...
class ExperimentFilesHandler:
    ...
    def __init__(
            self, exp_group: str, exp_name: str, run_name: str, log_dir: str):
        self.exp_group: str = exp_group
        self.exp_name: str = exp_name
        self.run_name: str = run_name
        self.path_base: Path = Path(log_dir) / self.exp_group / self.exp_name / self.run_name 
        self.path_logs = self.path_base / "logs"
        self.path_models = self.path_base / "models"
        self.path_metrics = self.path_base / "metrics"
        self.path_tensorb = self.path_base / "tb"
        self.path_embeddings = self.path_base / "embeddings"
    ...
    def get_existing_checkpoints(self) -> List[int]:
        ...
        ep_nums = sorted([int(a.split("trainerstate_")[-1].split(".json")[0])
    ...
    def get_existing_metrics(self) -> List[int]:
        ...
        # extract epoch numbers from those filenames
        ep_nums = sorted([int(a.split("metrics_epoch_")[-1].split(".json")[0])
                          for a in list_of_files])
        return ep_nums
    ...
    def get_models_file(self, epoch: Union[int, str]) -> Path:
        ...
        Returns:
            Path
        """
        return self.path_models / f"model_{epoch}.pth"
    ...
    def get_models_file_ema(self, epoch: Union[int, str]) -> Path:
        ...
        Returns:
            Path
        """
        return self.path_models / f"modelema_{epoch}.pth"
    ...
    def get_optimizer_file(self, epoch: Union[int, str]) -> Path:
        ...
        Returns:
            Path
        """
        return self.path_models / f"optimizer_{epoch}.pth"
    ...
    def get_data_file(self, epoch: Union[int, str]) -> Path:
        ...
        Returns:
            Path
        """
        return self.path_models / f"data_{epoch}.pth"
    ...
    def get_trainerstate_file(self, epoch: Union[int, str]) -> Path:
        ...
        Returns:
            Path
        """
        return self.path_models / f"trainerstate_{epoch}.json"
    ...
    def get_metrics_step_file(self, epoch: Union[int, str]) -> Path:
        ...
        Returns:
            Path
        """
        return self.path_metrics / f"metrics_step_{epoch}.json"
    ...
    def get_metrics_epoch_file(self, epoch: Union[int, str]) -> Path:
        ...
        Returns:
            Path
        """
        return self.path_metrics / f"metrics_epoch_{epoch}.json"
