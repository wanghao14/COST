...
class MartConfig(trainer_configs.BaseExperimentConfig):
    ...
    def __init__(self, config: Dict[str, Any]) -> None:
        ...
        self.branch = trainer_configs.BaseBranchConfig(config.pop("branch"))
        ...
        self.max_d_len: int = config.pop("max_d_len")
        self.max_a_len: int = config.pop("max_a_len")
        ...
        # added for my own model
        self.detect_feature_size: int = config.pop("detect_feature_size")
        self.action_feature_size: int = config.pop("action_feature_size")
        self.num_class_detect: int = config.pop("num_class_detect")
        self.num_class_action: int = config.pop("num_class_act")
        self.local_rank: int = config.pop("local_rank")
        self.distributed: bool = config.pop("distributed")
        self.dist_url = config.pop("dist_url")
        self.add_postion_embeddings: bool = config.pop("add_postion_embeddings")
        self.add_postion_embeddings_det: bool = config.pop("add_postion_embeddings_det")
        self.add_postion_embeddings_act: bool = config.pop("add_postion_embeddings_act")
        # self.distributed: bool = config.pop("world_size")
        # self.dist_url = config.pop("dist_url")
        # self.aspect_ratio_group_factor = config.pop("aspect_ratio_group_factor")
